...
export const CANNED_RESPONSES: CannedResponse[] = [
  {
    ...
    text: 'Thank you for reaching out. We have received your request and our team is reviewing it. You will receive updates as we progress.',
    tags: ['acknowledgement', 'support', 'queued'],
  },
  {
    id: 'req-logs',
    ...
    text: 'To help us investigate this issue further, could you please provide the relevant log files or error screenshots? This will help us identify the root cause more efficiently.',
    tags: ['logs', 'diagnostics', 'screenshots'],
  },
  {
    id: 'req-steps',
    label: 'Request Reproduction Steps',
    title: 'Request Reproduction Steps',
    category: 'Technical Support',
    ...
    text: 'Could you please provide detailed steps to reproduce this issue? Include the browser/device you are using, and any specific actions that trigger the problem.',
    tags: ['reproduce', 'browser', 'steps'],
  },
  {
    id: 'known-outage',
    label: 'Known Service Outage',
    title: 'Known Service Outage',
    ...
    text: 'We are aware of the current service disruption and our engineering team is actively working on a resolution. We will provide an update within the next 2 hours. We apologize for the inconvenience.',
    tags: ['outage', 'downtime', 'incident'],
  },
  {
    id: 'billing-review',
    label: 'Billing Under Review',
    title: 'Billing Under Review',
    ...
    text: 'We have forwarded your billing inquiry to our accounts team for review. You should expect a detailed response within 24-48 hours. If the issue is urgent, please contact our billing hotline directly.',
  ...
  },
  {
    ...
    text: 'This issue has been escalated to our senior engineering team for priority handling. You will be notified as soon as we have an update or resolution.',
    tags: ['escalated', 'tier2', 'priority'],
  },
  {
    ...
    text: 'The reported issue has been resolved. Please verify on your end and confirm if everything is working as expected. If the problem persists, feel free to reopen this ticket.',
    tags: ['resolved', 'fixed', 'confirmation'],
  },
  {
    id: 'feature-noted',
    ...
    text: 'Thank you for your feature suggestion! We have added it to our product backlog for evaluation. Our product team reviews all suggestions during sprint planning cycles.',
    tags: ['feature', 'feedback', 'roadmap'],
  },
  {
    id: 'security-patch',
    ...
    text: 'A security patch has been deployed to address the reported vulnerability. We recommend clearing your browser cache and logging in again. If you continue to experience issues, please let us know.',
    tags: ['security', 'patch', 'cache'],
  },
  {
    id: 'closing-inactive',
    label: 'Closing Due to Inactivity',
    title: 'Closing Due to Inactivity',
    category: 'General',
    ...
    text: 'This ticket has been inactive for over 7 days. We are closing it as resolved. If you still need assistance, please reopen the ticket or create a new one.',
    tags: ['close', 'inactive', 'auto-close'],
  },
];
